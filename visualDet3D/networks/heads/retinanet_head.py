...
class RetinanetHead(nn.Module):
    ...
    def __init__(self,  stacked_convs=4,
        ...
        self.anchors = Anchors(preprocessed_path=None, readConfigFile=False, **anchors_jfc)
    ...
    def get_bboxes(self, cls_scores, reg_preds, anchors):
        ...
        pre_nms_num = getattr(self.test_jfc, 'nms_pre', 1000)
    ...
    def loss(self, cls_scores, reg_preds, anchors, annotations):
        ...
        for j in range(batch_size):
            ...
            assignement_result_dict = self._assign(anchor, bbox_annotation, **self.loss_jfc)
